...
export default function TasksPage() {
  ...
  const [search, setSearch] = useState(''); const [filters, setFilters] = useState({ status: '', priority: '', assignee_id: '', sort_by: 'updated_at', sort_dir: 'desc' });
